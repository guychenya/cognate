...
# Use a specific model from OpenRouter
cognate --model openai/gpt-4o "refactor the entire API layer"
```

## Acknowledgments

This project is an evolution of the original **[Claudish](https://github.com/MadAppGang/claudish)** created by Jack Rudenko at MadAppGang. We are grateful for their foundational work.

The core proxy implementation is based on the excellent **[claude-code-proxy](https://github.com/kiyo-e/claude-code-proxy)** by [@kiyo-e](https://github.com/kiyo-e).
